...
const UserImportModal = ({ fetchUsers, setIsLoading, setLoadingText }) => {
  ...
  const triggerConfirmation = () => {
    ...
    const firstModalEl = document.getElementById("importUserModal");
  ...
  const executeImport = async () => {
    ...
    setIsLoading(true);
    setLoadingText("Importing users...");
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/users/import`,
        formData,
        {
          headers: {
  ...
  const goBackToImportModal = () => {
    const secondModalEl = document.getElementById("importConfirmModal");
    ...
    setTimeout(() => {
      const firstModal = new Modal(document.getElementById("importUserModal"));
      firstModal.show();
    }, 400);
  };
          ...
          <div className="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div className="modal-body p-4 bg-white">
              <p className="text-muted small mb-3">
                Attach your CSV file containing the user records.
              </p>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            ...
            <div className="modal-body text-center p-4">
              <h4 className="fw-bold text-dark">Import Users</h4>
              <p className="text-muted mb-0">
                You are about to import users from <b>{importFile?.name}</b>.
                The system will auto-generate secure passwords and send
                verification links to the emails. Proceed?
              </p>
            </div>
