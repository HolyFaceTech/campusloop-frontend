...
const StudentFiles = () => {
  ...
  const fetchFiles = async () => {
    ...
    try {
      const res = await axios.get(
        `${import.meta.env.VITE_API_BASE_URL}/student/files`,
        {
          headers: {
  ...
  const handleViewDocument = (filePath) => {
    ...
    // Depende sa pag-save mo, kung wala pang /storage/ sa unahan, idadagdag ito
    const formattedPath =
  ...
  const executeDownloadZip = async () => {
    ...
    try {
      const response = await axios.post(
        `${import.meta.env.VITE_API_BASE_URL}/student/files/download-zip`,
      ...
      link.href = url;
      link.setAttribute("download", `My_Files_${new Date().getTime()}.zip`);
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-start mb-4 gap-3">
        <div>
          ...
          <p className="text-muted small mb-0">
            View and download all your attached files and submissions.
          </p>
        </div>
                  ...
                  <div className="card-body p-3 d-flex flex-column position-relative">
                    ...
                    >
                      ...
                      <div className="overflow-hidden w-100">
                        ...
                        <p
                          className="text-muted small fw-medium mb-0 font-monospace text-uppercase"
