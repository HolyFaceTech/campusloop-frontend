            ...
            <div className="col-md-7 position-relative">
              ...
              >
                <p className="text-muted small mb-4">
                  Welcome to the Student Help Center. Click on the topics below
                  to learn how to navigate your classes, submit activities, and
                  view your grades.
                </p>
