...
const TeacherHome = () => {
  ...
  const saveEditedComment = async (commentId) => {
    ...
    try {
      await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/teacher/comments/${commentId}`,
        { content: editContent },
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("campusloop_token") || sessionStorage.getItem("campusloop_token")}`,
            ...
            <div className="card-body p-4 p-md-5 position-relative z-1 d-flex align-items-center">
              <div className="text-white w-75">
                ...
                <p
                  ...
                  style={{ fontSize: "1rem" }}
                >
                  Ready to inspire? Check your pending tasks and recent
                  announcements below.
                </p>
              </div>
              <img
          ...
          >
            ...
            >
              {data.todos.length === 0 ? (
                <div className="p-4 text-center">
                  <i
                    className="bi bi-check2-circle text-success opacity-50 d-block mb-2"
                    style={{ fontSize: "3rem" }}
                  ></i>
                  <span className="d-block fw-bold text-dark mb-1">
                    All caught up!
                  ...
                  {data.todos.map((todo, index) => (
                    <React.Fragment key={todo.id}>
                      <div
                        ...
                        onClick={() =>
                          navigate(
                            `/teacher/classrooms/${todo.classwork?.classroom_id}/stream`,
                          )
                        }
                      >
                        <div className="d-flex align-items-start gap-2">
                          ...
                          <div className="flex-grow-1 overflow-hidden">
                            <div className="d-flex justify-content-between align-items-start mb-1 gap-2">
                              <span
                                className="small fw-bold text-dark text-truncate d-block"
                                title={todo.classwork?.title}
                              >
                                {todo.classwork?.title}
                              </span>
                            ...
                            >
                              <span>
                                ...
                                <span className="fw-bold text-dark">
                                  {todo.student?.first_name}{" "}
                                  {todo.student?.last_name}
                                </span>
                              </span>
                            </div>
                          </div>
