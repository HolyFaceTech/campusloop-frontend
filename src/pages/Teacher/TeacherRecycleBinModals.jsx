...
const TeacherRecycleBinModals = ({ selectedCount, executeAction }) => {
  return (
    <div
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
          <div className="modal-header border-0 pb-0 justify-content-center mt-4">
            <div
              className="rounded-circle d-flex justify-content-center align-items-center bg-success bg-opacity-10"
              style={{ width: "80px", height: "80px" }}
            >
              <i
                className="bi bi-arrow-counterclockwise text-success"
          ...
          <div className="modal-footer border-0 d-flex justify-content-center pb-4 pt-0 gap-2">
            ...
            <button
              type="button"
              className="btn px-4 fw-medium shadow-sm rounded-3 btn-success"
              data-bs-dismiss="modal"
...
export default TeacherRecycleBinModals;
